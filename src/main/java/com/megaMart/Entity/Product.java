...
public class Product {
	...
	@Id
	/*
	 * @GenericGenerator(name = "sequence_product_id", strategy =
	 * "com.megaMart.Entity.ProductIdGenerator")
	 * 
	...
	public Product(String productId, String productName, String description, double price, double discount,
